	...
	>
		<div class="mx-auto flex h-20 max-w-5xl items-center justify-between px-4 sm:px-6">
			<a href="{base}/" class="group flex items-center gap-3 outline-none">
				<div
					class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-indigo-700 text-white shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:rotate-3"
				>
			...
			<div class="flex items-center gap-6">
				...
				{:else}
					<div class="flex items-center gap-4">
						...
						<a
							href="{base}/register"
							class="rounded-xl bg-blue-600 px-6 py-2 text-sm font-bold text-white shadow-lg transition-all hover:-translate-y-0.5 hover:bg-blue-700"
							>註冊</a
						>
					</div>
				{/if}
