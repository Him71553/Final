...
<div class="flex min-h-[85vh] items-center justify-center px-4 py-12">
    ...
    >
        ...
        <div class="p-8 sm:p-10">
            ...
            {#if errorMessage}
                <div transition:slide class="mb-6 rounded-lg bg-red-50 p-4 text-sm text-red-600 dark:bg-red-900/20 dark:text-red-400">
            ...
            <form class="flex flex-col gap-5" on:submit|preventDefault={handleSubmit}>
                <div class="group">
                    ...
                    <div class="relative">
                        ...
                        />
                        <div class="pointer-events-none absolute left-0 top-0 flex h-full w-11 items-center justify-center text-slate-400 peer-focus:text-blue-500 transition-colors">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button 
                            ...
                            class="absolute right-0 top-0 flex h-full w-12 items-center justify-center text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 focus:outline-none"
                            tabindex="-1"
                        >
                            {#if showPassword}
                ...
                <div>
                    <label for="confirmPassword" class="mb-1.5 block text-sm font-semibold text-slate-700 dark:text-slate-300">
                        確認密碼
                    </label>
                    <input
                        type="password"
                ...
                <div class="mt-4 text-center text-sm text-slate-500 dark:text-slate-400">
                    已經有帳號了？ 
                    <a href={resolve('/login')} class="font-semibold text-blue-600 hover:underline hover:text-blue-700 dark:text-blue-400">
                        立即登入
                    </a>
                </div>
            </form>
