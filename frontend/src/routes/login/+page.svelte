    ...
    >
        <div class="p-8 sm:p-10">
            ...
            <form class="flex flex-col gap-6" on:submit|preventDefault={handleSubmit}>
                <div>
                    <label for="username" class="mb-1.5 block text-sm font-semibold text-slate-700 dark:text-slate-300">
                        使用者名稱
                    </label>
                    <div class="relative">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            required
                            placeholder="••••••••"
                            class="block w-full rounded-lg border border-slate-300 bg-white py-2.5 pl-10 pr-10 text-slate-900 placeholder-slate-400 transition-all focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 focus:outline-none dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:focus:ring-blue-500/20"
                        />
                        <button 
                            type="button"
                ...
                <button
                    ...
                    class="mt-2 flex w-full items-center justify-center rounded-lg bg-blue-600 px-4 py-2.5 text-base font-bold text-white shadow-md shadow-blue-500/20 transition-all 
                           hover:bg-blue-700 hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-blue-500/50 
                           disabled:cursor-not-allowed disabled:opacity-70"
                >
                    {#if isLoading}
                        <svg class="mr-3 h-5 w-5 animate-spin text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                        登入中...
                    {:else}
                        立即登入
                    {/if}
            ...
            <p class="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
                還沒有帳號？
                <a href={resolve('/register')} class="font-semibold text-blue-600 transition hover:text-blue-500 hover:underline dark:text-blue-400">
                    免費註冊
                </a>
            </p>
        </div>
